...
\long\def\inso@C@insert@last#1\fi\inso@C@ifsmaller#2\inso@qstop#3%>>=
  {%
    \fi
...
\long\def\inso@C@fi@gobblesort%>>=
  \fi\inso@C@getvalue#1\expandafter\inso@C@insert\expandafter#2\inso@C@sort
  {\fi}%=<<
